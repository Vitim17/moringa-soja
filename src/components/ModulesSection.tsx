  ...
  return (
    <section className="py-20 sm:py-28 bg-background">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        ...
        {/* Caminho dinâmico: módulo 1 → 2 → ... → 10 */}
        <div className="relative flex flex-col items-center gap-0">
          {/* Container da linha: só até o último módulo, para não atravessar o card de parabéns */}
          <div className="relative flex flex-col items-center w-full">
            ...
            >
              ...
              <motion.div
                ...
                className="relative z-10 w-full max-w-md bg-card rounded-2xl p-6 border-2 border-border shadow-lg hover:shadow-xl hover:border-primary/40 transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    {mod.free && (
                      <span className="inline-block mb-2 px-2 py-0.5 rounded-full bg-primary/20 text-primary text-xs font-heading font-bold uppercase">
                        Grátis
                      </span>
                    )}
                    ...
                    <h3 className="font-heading font-bold text-card-foreground mt-1 text-lg leading-snug">
                      {mod.title}
                    </h3>
                  </div>
                </div>
              ...
              {/* Conector (caminho) para o próximo módulo — exceto após o 10 */}
              {i < modules.length - 1 && (
                <motion.div
                  initial={{ opacity: 0 }}
          ...
          {/* Mensagem final após o módulo 10 (fora da linha) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="flex flex-col items-center gap-4 bg-primary/10 border-2 border-primary/30 rounded-2xl p-8 text-center">
              <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center">
                <Trophy className="w-8 h-8 text-primary-foreground" />
              </div>
              <p className="font-heading font-bold text-xl sm:text-2xl text-foreground leading-snug">
